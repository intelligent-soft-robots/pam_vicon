...
class FixedSizeViconFrame:
    ...
    frame_rate: float
    latency: float
    subjects: List[vicon_transformer.vicon_transformer_bindings.SubjectData[10]]
    time_stamp: int
...
class Subjects:
    ...
    ARM: ClassVar[Subjects] = ...
    BALL_LAUNCHER: ClassVar[Subjects] = ...
    LED_STICK: ClassVar[Subjects] = ...
    MUSCLE_BASE: ClassVar[Subjects] = ...
    MUSCLE_RACKET: ClassVar[Subjects] = ...
...
def get_subject_names() -> List[str[10]]: ...
